 ...
 * @author Saikiran
 */
public class AddEventsToDatabase extends HttpServlet {
    ...
    public void service(HttpServletRequest req , HttpServletResponse res) throws IOException
    {
        ...
        try {
                ...
                stmt.executeUpdate();
                session.setAttribute("message","Event added succesfully");
                res.setHeader("Refresh", "2; URL=AddEvent.jsp");
        ...
        catch(Exception e)
        {
            ...
            session.setAttribute("message","Event added succesfully");
          //out.println(e);
           //res.setHeader("Refresh", "5; URL=AddEvents.jsp");
        }
