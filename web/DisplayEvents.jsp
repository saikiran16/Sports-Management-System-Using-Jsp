...
%>
    <body>
        ...
        <br><br><br><br>
        <div style="font-family: fantasy ; text-align: center;font-size: 30px;box-shadow: 2px 20px 51px  10px  #00cccc;"> Events</div>
        <br>
    ...
    <div >
        <table>
         <%
             int sno = 1;
                    String query = "select  * from events   where  rownum <= 10  order by dateOfadd desc ";
                   Connection conn;
